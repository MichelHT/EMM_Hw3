...
Concentration_Coef          = DefineNumber[4.4   , Name StrCat[PathElectricalParameters, "12Correction of the concentration of flux at the rounded corner of the core"], Highlight "Red"   ];
