...
// Boucherot formulation: We basically impose the core thickness so that the magnetic flux generated by one single phase lead to B_sat in a 
// magnetic circuit of width W_Ref. 
Thickness_Core    = (Voltage_primary)/((2*Pi)/(Sqrt[2]))/Freq/B_sat/Primary_Turns/W_Ref;
...
// center of the core. The value 2.9 has been manually adjusted so that the maximum flux density reached at the rounded corner of the core is equal to B_sat.
Thickness_Core  = Thickness_Core *(2.9/B_sat); 
