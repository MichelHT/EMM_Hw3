...
Physical Surface("AIR") = {21};								// Region 1
Physical Surface("AIR_INF") = {20};							// Region 2
Physical Surface("CORE") = {1};								// Region 3
Physical Surface("Primary_Phase1_Plus") = {8};				// Region 4
Physical Surface("Primary_Phase2_Plus") = {9};				// Region 5
Physical Surface("Primary_Phase3_Plus") = {10};				// Region 6
Physical Surface("Primary_Phase1_Minus") = {11};			// Region 7
Physical Surface("Primary_Phase2_Minus") = {12};			// Region 8
Physical Surface("Primary_Phase3_Minus") = {13};			// Region 9
Physical Surface("Secondary_Phase1_Plus") = {14};			// Region 10
Physical Surface("Secondary_Phase2_Plus") = {15};			// Region 11
Physical Surface("Secondary_Phase3_Plus") = {16};			// Region 12
Physical Surface("Secondary_Phase1_Minus") = {17};			// Region 13
Physical Surface("Secondary_Phase2_Minus") = {18};			// Region 14
Physical Surface("Secondary_Phase3_Minus") = {19};			// Region 15
